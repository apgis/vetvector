...
// const API_URL = process.env.REACT_APP_BACKEND_URL || "http://localhost:5000"; // Backend URL from .env
// const PREDICTION_API_URL = process.env.REACT_APP_AI_URL || "http://localhost:3000"; // AI Prediction API URL
...
// export const predictDisease = async (symptoms) => {
//     try {
//         const response = await axios.post(`${PREDICTION_API_URL}/api/predict`, { symptoms });
//         return response.data;
//     } catch (error) {
//         console.error("Error predicting disease:", error);
//         return { error: "Failed to predict disease" };
